...
import { ChrckField } from "./ChrckField";
import * as _utils from "./utils";
import _styles from "./FilterFormBlock.module.css";
...
export function FilterFormBlock({ as: _Component = _Builtin.FormWrapper }) {
    ...
    <_Component className={_utils.cx(_styles, "filter_form_block")}>
      ...
      >
        <_Builtin.Block
          ...
          id={_utils.cx(
            _styles,
            "w-node-b735f83f-01bc-a2ae-83dc-4c758d3082ad-8d3082ab"
          )}
          tag="div"
        >
          <_Builtin.Block
          ...
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "filter_block_title-2")}
              id={_utils.cx(
                _styles,
                "w-node-b735f83f-01bc-a2ae-83dc-4c758d3082af-8d3082ab"
              )}
              tag="div"
            >
              {"Featured"}
            ...
            <_Builtin.Block
              ...
              id={_utils.cx(
                _styles,
                "w-node-b735f83f-01bc-a2ae-83dc-4c758d3082b1-8d3082ab"
              )}
              tag="div"
            >
        ...
        >
          ...
          >
            <_Builtin.Block
              ...
              id={_utils.cx(
                _styles,
                "w-node-b735f83f-01bc-a2ae-83dc-4c758d3082ba-8d3082ab"
              )}
              tag="div"
            >
              {"Filter by make"}
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "fs-message_active")}
          id={_utils.cx(
            _styles,
            "w-node-b735f83f-01bc-a2ae-83dc-4c758d3082ca-8d3082ab"
          )}
          tag="div"
        >
          <_Builtin.Block tag="div">
            {
              "This is a block containing a checkbox with the 'active' class. The 'active' class will be added to the button when it is clicked. You can hide this block if you want."
            }
          </_Builtin.Block>
          <_Builtin.FormCheckboxWrapper
            className={_utils.cx(_styles, "check_field", "is-list-active")}
          >
            <_Builtin.FormCheckboxInput
              className={_utils.cx(_styles, "checkbox_input-2", "helper")}
              type="checkbox"
              name="Checkbox-Active"
              data-name="Checkbox Active"
              required={false}
              checked={false}
              id="Checkbox-Active"
              form={{
