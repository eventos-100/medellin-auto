...
import _styles from "./Go.module.css";
...
export function Go({ as: _Component = _Builtin.Block }) {
  ...
  return (
    <_Component className={_utils.cx(_styles, "go")} tag="section">
      <_Builtin.Block className={_utils.cx(_styles, "go_img")} tag="div">
        <_Builtin.Block
          className={_utils.cx(
            _styles,
            "hero-flex__item",
      ...
      <_Builtin.Block className={_utils.cx(_styles, "go_text")} tag="div">
        <_Builtin.Block
          className={_utils.cx(
            _styles,
            "hero-grid__subheading",
