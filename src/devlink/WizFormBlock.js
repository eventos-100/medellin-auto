...
import { WizFilterHeader } from "./WizFilterHeader";
import { WizFilterList } from "./WizFilterList";
import { WizFilterBlock } from "./WizFilterBlock";
import { WizClear } from "./WizClear";
import * as _utils from "./utils";
import _styles from "./WizFormBlock.module.css";
...
export function WizFormBlock({ as: _Component = _Builtin.FormWrapper }) {
    ...
    <_Component className={_utils.cx(_styles, "filter_form_block")}>
      ...
      >
        ...
        <_Builtin.Block
          ...
          id={_utils.cx(
            _styles,
            "w-node-d4005df6-8b1e-af9a-4b9c-83143d5ac5ac-3d5ac5a8"
          )}
          tag="div"
        >
          <_Builtin.Block
          ...
          >
            <_Builtin.Block
              ...
              id={_utils.cx(
                _styles,
                "w-node-d4005df6-8b1e-af9a-4b9c-83143d5ac5ae-3d5ac5a8"
              )}
              tag="div"
            >
              {"Featured"}
            ...
            <_Builtin.Block
              ...
              id={_utils.cx(
                _styles,
                "w-node-d4005df6-8b1e-af9a-4b9c-83143d5ac5b0-3d5ac5a8"
              )}
              tag="div"
            >
