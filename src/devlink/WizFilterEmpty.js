...
import _styles from "./WizFilterEmpty.module.css";

export function WizFilterEmpty({ as: _Component = _Builtin.Block }) {
  return (
    <_Component
      className={_utils.cx(_styles, "filter_empty-5", "helper")}
      tag="div"
