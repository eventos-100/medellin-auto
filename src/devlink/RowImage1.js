...
import _styles from "./RowImage1.module.css";
...
export function RowImage1({ as: _Component = _Builtin.Block }) {
  _interactions.useInteractions(_interactionsData, _styles);

  return (
    <_Component className={_utils.cx(_styles, "ludicrous")} tag="section">
      <_Builtin.Block
        className={_utils.cx(_styles, "ludicrous__img", "ludicrous__img-2")}
        tag="div"
      >
        <_Builtin.Block
          className={_utils.cx(
      ...
      >
        ...
        <_Builtin.Block
          ...
          id={_utils.cx(
            _styles,
            "w-node-df84a067-7bc4-ed78-f710-e5ae98974368-98974351"
          )}
          tag="div"
        >
          <_Builtin.Paragraph
